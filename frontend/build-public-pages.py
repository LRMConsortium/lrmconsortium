 ...
 **Every figure on this page is either read from the code or marked as needing
 confirming.** The marketplace commission, the escrow release window and the
 free cancellation window are real — they are `DEFAULT_MARKETPLACE_COMMISSION_
 PERCENT`, `AUTO_RELEASE_DAYS` and `FREE_CANCELLATION_HOURS` in
 `modules/marketplace/orderMath.ts`, and `verify-public-pages.py` reads that
 file and fails if this page and the code disagree.

 The rental management fee is **not** known. It is marked, not guessed. A
 published fee that turns out to be wrong is a promise LRMC did not mean to
 make, and it is worse than an obvious gap.
 ═══════════════════════════════════════════════════════════════════════════''',
  ...
  <section class="bg-slate-50 border-y border-slate-200" aria-labelledby="landlords-heading">
    <div class="max-w-4xl mx-auto px-4 lg:px-6 py-12">
      ...
      <div class="lrmc-card">
        <p class="lrmc-stat-value mb-1">''' + needs('management fee to confirm') + '''</p>
        <p class="text-slate-600 mb-4">
  ...
  <section class="bg-slate-50 border-y border-slate-200" aria-labelledby="ususu-heading">
    <div class="max-w-4xl mx-auto px-4 lg:px-6 py-12">
      ...
      <div class="lrmc-card">
        <p class="lrmc-stat-value mb-1">''' + needs('driver commission to confirm') + '''</p>
        <p class="text-slate-600">
